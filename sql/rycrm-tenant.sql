...
-- ----------------------------
BEGIN;
INSERT INTO `gen_table` VALUES (1, 'crm_customer', '客户表', NULL, NULL, 'CrmCustomer', 'crud', 'com.vrmlstudio.crm', 'crm', 'customer', '客户', 'vrmlstudio', '0', '/', '{}', 'admin', '2022-01-12 18:02:20', '', '2022-01-19 15:18:30', NULL);
INSERT INTO `gen_table` VALUES (2, 'crm_comment', '客户跟进记录表', NULL, NULL, 'CrmComment', 'crud', 'com.vrmlstudio.crm', 'crm', 'comment', '跟进记录', 'vrmlstudio', '0', '/', '{\"parentMenuId\":\"2008\"}', 'admin', '2022-01-18 14:56:58', '', '2022-01-18 15:06:30', NULL);
INSERT INTO `gen_table` VALUES (3, 'crm_order', '订单表', NULL, NULL, 'CrmOrder', 'crud', 'com.vrmlstudio.crm', 'crm', 'order', '我的订单', 'vrmlstudio', '0', '/', '{\"parentMenuId\":\"2008\"}', 'admin', '2022-01-18 18:10:56', '', '2022-01-19 10:54:01', NULL);
COMMIT;
